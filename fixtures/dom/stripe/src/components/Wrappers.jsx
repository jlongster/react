    ...
    <LinkOuter>
      <LinkContainer>
        <LinkElement
          data-testid={testId}
          href={href}
          style={{ color: '#635bff', textDecoration: 'none', ...style }}
        >
          <LinkContent>
            <LinkInner>
...
export function Divider() {
  return (
    <DividerOuter>
      <DividerContainer>
        <DividerElement
          style={{ height: '1px', backgroundColor: '#e3e8ee', width: '100%' }}
        >
          <DividerInner />
        </DividerElement>
      </DividerContainer>
...
export function DeepNest({ depth = 10, children }) {
  ...
  //     aggregatedMetrics[eventType].avgConversion /=
  //       aggregatedMetrics[eventType].samples;
  //   }
  ...
  //         const ruleName =
  //           validationRules[(fieldIndex + ruleIndex) % validationRules.length];
  //         rules.push({
  //           name: ruleName,
  //           value:
  //             ruleName === 'minLength'
  ...
  //       {
  //         source: `field_${formIndex}_0`,
  //         target: `field_${formIndex}_1`,
  //         condition: 'notEmpty',
  //       },
  //       {
  //         source: `field_${formIndex}_2`,
  //         target: `field_${formIndex}_3`,
  //         condition: 'equals',
  //         value: 'show',
  //       },
  //       {
  //         source: `field_${formIndex}_4`,
  //         target: `field_${formIndex}_5`,
  ...
  //       const toState =
  //         stateNames[
  //           (transitionIndex + 1 + Math.floor(transitionIndex / 3)) %
  //             stateNames.length
  //         ];
  ...
  //       transform: data => {
  //         if (operation === 'map')
  //           return Array.isArray(data) ? data.map(x => x) : data;
  //         if (operation === 'filter')
  //           return Array.isArray(data) ? data.filter(() => true) : data;
  //         if (operation === 'reduce')
  //           return Array.isArray(data) ? data.reduce((a, b) => a, null) : data;
  //         return data;
  //       },
  ...
  //         dependencies:
  //           pipelineIndex > 0 ? [`transformer_${pipelineIndex - 1}`] : [],
  //       },
  //     });
  ...
  //       direction:
  //         locale.startsWith('ar') || locale.startsWith('he') ? 'rtl' : 'ltr',
  //       numberFormat: {
  //         decimal: locale.includes('DE') ? ',' : '.',
  //         thousands: locale.includes('DE') ? '.' : ',',
  //         currency: locale.includes('US') ? '$' : '€',
  //       },
  //       dateFormat: {
  //         short: locale.includes('US') ? 'MM/DD/YYYY' : 'DD/MM/YYYY',
  //         long: 'MMMM D, YYYY',
  //         time: locale.includes('US') ? 'h:mm A' : 'HH:mm',
  //       },
  //       pluralRules: {
  //         zero: 0,
  //         one: 1,
  ...
  //           gender:
  //             keyIndex % 7 === 0
  //               ? { male: 'his', female: 'her', neutral: 'their' }
  //               : null,
  ...
  //     const translation =
  //       i18nSystem.translations[locale]?.[namespace]?.[translationKey];
  ...
  //   i18nSystem.hasTranslation = (key, locale) =>
  //     Boolean(
  //       i18nSystem.translations[locale]?.[key.split('.')[0]]?.[
